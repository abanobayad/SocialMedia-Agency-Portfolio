                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{route('dologin')}}" role="form">
                                        @csrf
                                        <div class="mb-3">
                                            <input name="email" type="email" value="{{old('email')}}" class="form-control form-control-lg" placeholder="Email"
                                                aria-label="Email">
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    {{-- <p class="mb-4 text-sm mx-auto">
                                        ...
                                        <a href="{{route('reg')}}" href="javascript:;" class="text-primary text-gradient font-weight-bold">Sign
                                            up</a>
                                    </p> --}}
                                    <p class="mb-4 text-sm mx-auto">
                                        Forgot Password?
                                        <a href="{{route('forgot')}}" href="javascript:;" class="text-primary text-gradient font-weight-bold">Click
                                            here</a>
                                    </p>
                                </div>
                            </div>
